...
// Central billing authority — subscription status lookup.
// GET ?userId=  returns current subscription or free defaults.
...
const FREE_SUB = { plan_tier: 'free', status: 'active', provider: 'none', current_period_end: null }
