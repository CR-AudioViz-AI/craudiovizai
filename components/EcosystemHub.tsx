  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-gray-900 rounded-2xl w-full max-w-4xl max-h-[85vh] overflow-hidden border border-gray-700 shadow-2xl">
        {/* Header */}
        <div className="p-4 border-b border-gray-800 bg-gradient-to-r from-cyan-400/10 to-cyan-500/10">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-cyan-400"
            />
          </div>
        </div>
                ...
                {filteredApps.map(app => (
                  <a
                    ...
                    className={`p-4 bg-gray-800 hover:bg-gray-750 rounded-xl transition-all group ${
                      currentApp === app.id ? 'ring-2 ring-cyan-400' : ''
                    }`}
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          ...
                          {currentApp === app.id && (
                            <span className="px-1.5 py-0.5 bg-cyan-400 text-white text-xs rounded">Current</span>
                          )}
          ...
          {activeTab === 'assets' && (
            <div className="p-4">
              <div className="flex items-center justify-between mb-4">
                ...
                <button className="flex items-center gap-2 px-3 py-1.5 bg-cyan-400 hover:bg-cyan-400 rounded-lg text-sm">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                ...
                <button className="aspect-square bg-gray-800 rounded-lg border-2 border-dashed border-gray-700 hover:border-cyan-400 flex flex-col items-center justify-center gap-2 transition-colors">
              ...
              <div className="mt-6 p-4 bg-cyan-400/10 border border-cyan-400/30 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-cyan-400">Sync Across All Apps</p>
        ...
        <div className="p-4 border-t border-gray-800 bg-gray-800/50">
          <div className="flex items-center justify-between">
            <p className="text-sm text-gray-400">
              <span className="text-cyan-400 font-medium">{ECOSYSTEM_APPS.length} apps</span> in your ecosystem
            </p>
            <a
              href="https://cr-audioviz-ai.vercel.app"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-cyan-400 to-cyan-500 rounded-lg text-sm font-medium hover:opacity-90"
            >
              View All Apps
              <ExternalLink className="w-4 h-4" />
            </a>
